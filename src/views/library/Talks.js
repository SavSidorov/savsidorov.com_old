...
export default function Talks() {
	return (
		<Styles>
      <Navigation/>
			<p>Talks & lectures that I frequently come back to...</p>
			<br/>
			<div className="Talks">
				...
				<iframe title="Kevin Spacey" width="400" height="225" src="https://www.youtube.com/embed/oheDqofa5NM" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
