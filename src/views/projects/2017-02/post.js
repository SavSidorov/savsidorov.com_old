		...
		<BlogStyle>
			...
			<div className="post">
				...
				<p>
					...
					autonomous functions and could be human controlled. The bot was capable of carrying gears (plastic game
					pieces), collecting and shooting plastic balls, climbing up a velcro rope and moving seamlessly across the
					field. Toggle was built on a mecanum drive train, allowing it to move omnidirectionally. Each wheel had a
					separate gearbox and could move independently. The custom gear ratios allowed it to reach one of the highest
					top speeds on the field. Due to the omnidirectional movement, the ‘front’ of the robot could be toggled
					between two modes, changing the control scheme to make operation easier. All of this resulted in a versatile
					and fast robot that ranked 4th out of 48 teams by OPR (offensive contribution to the team).
				</p>
				<div className="color-box">
					<p>
						• Check out videos of ‘Toggle’ in action <a href="https://www.youtube.com/watch?v=EHVaOwvWSi0">here</a> and{" "}
